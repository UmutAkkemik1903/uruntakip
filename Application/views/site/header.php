...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="<?=SITE_URL;?>" class="logo">
            ...
            <span class="logo-mini"><b>Ü</b>TS</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>Ürün</b>Takip</span>
        </a>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <a href="<?=SITE_URL;?>/cikis" class="btn btn-default btn-flat">Çıkış Yap</a>
                                </div>
                            </li>
                        </ul>
                    </li>
