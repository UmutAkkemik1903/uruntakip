...
<div class="login-box">
    <div class="login-logo">
        <a href="<?=SITE_URL;?>"><b>Üye</b>KAYIT</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        ...
        <form action="<?=SITE_URL;?>/create/send" method="post">
            ...
            <div class="row">
                ...
                <!-- /.col -->
                <div class="col-xs-4">
                    <button type="submit" class="btn btn-primary btn-block btn-flat">Kayıt Yap</button>
